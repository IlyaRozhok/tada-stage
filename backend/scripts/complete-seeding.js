...
const propertyTemplates = [
  ...
  [
    {
      ...
      lifestyle_features: ["Balcony", "Gym", "Concierge", "Parking"],
    },
    {
    ...
    },
    {
      ...
      lifestyle_features: ["Garden", "Garage", "Fireplace", "Study"],
    },
    {
      ...
      lifestyle_features: ["River view", "Gym", "Pool", "24/7 security"],
    },
    {
  ...
  [
    {
      ...
      furnishing: "furnished",
      available_from: "2024-01-15",
      lifestyle_features: ["Gym", "Concierge", "Parking", "Balcony"],
    },
    {
      ...
      furnishing: "furnished",
      available_from: "2024-02-01",
      lifestyle_features: ["Study desk", "High-speed internet", "Laundry"],
    },
    {
      ...
      furnishing: "unfurnished",
      available_from: "2024-01-20",
      lifestyle_features: ["Garden", "Garage", "Driveway", "Conservatory"],
    },
    {
      ...
      lifestyle_features: ["River view", "Gym", "Pool", "Concierge"],
    },
    {
  ...
  [
    ...
    },
    {
      ...
      furnishing: "furnished",
      available_from: "2024-02-01",
      lifestyle_features: ["Study area", "High-speed internet", "Laundry"],
    },
    {
    ...
    },
    {
      ...
      furnishing: "furnished",
      available_from: "2024-02-05",
      lifestyle_features: ["Canal view", "Gym", "Pool", "Concierge"],
    },
    {
  ...
  [
    ...
    },
    {
      ...
      furnishing: "unfurnished",
      available_from: "2024-01-20",
      lifestyle_features: ["Garden", "Garage", "Period features", "Fireplace"],
    },
    {
      ...
      furnishing: "furnished",
      available_from: "2024-02-05",
      lifestyle_features: ["Harbor view", "Modern kitchen", "Balcony"],
    },
    {
  ...
  [
    {
      ...
      furnishing: "furnished",
      available_from: "2024-01-15",
      lifestyle_features: ["Harbor view", "Balcony", "Modern amenities"],
    },
    {
      title: "Student Accommodation",
      description: "Perfect for students near universities.",
    ...
    },
    {
      ...
      furnishing: "unfurnished",
      available_from: "2024-01-20",
      lifestyle_features: ["Garden", "Period features", "Fireplace", "Study"],
    },
    {
      ...
      furnishing: "furnished",
      available_from: "2024-02-05",
      lifestyle_features: ["City view", "Modern kitchen", "Balcony"],
    },
    {
...
async function completeSeeding() {
  ...
  console.log("📋 Creating operators, properties, and adding images...\n");
    ...
    for (let j = 0; j < PROPERTIES_PER_OPERATOR; j++) {
      ...
      if (createdProperty) {
        ...
        operatorResult.properties.push({
          ...
          images_added: propertyImages.length,
        });
      }
    }
...
completeSeeding().catch(console.error);
